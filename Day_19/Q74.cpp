...
vector<vector<int>> matrix_subtract(vector<vector<int>> &matrix1,vector<vector<int>> &matrix2,int rows,int col){
...
int main(){
    ...
    vector<vector<int>> summation_matrix = matrix_subtract(matrix1,matrix2,rows,col);
